...
`r .kwallm_report_text_count_summary(analysis_result)` The LLM (model: `r htmltools::htmlEscape(main_model)`) was asked to mark texts that belonged to one of the following codes:
...
the column 'Code' contains the code for which the text was marked, and the column 'Marked text' contains the literal text span returned by the language model.
