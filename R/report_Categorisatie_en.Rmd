...
`r nrow(report_df)` texts were analyzed with a LLM (model: `r htmltools::htmlEscape(main_model)`),
during which the LLM was asked to assign one of the following `r length(categories)` categories to each text:
...
if (!assign_multiple_categories) {
    ...
    cat_cols <- setdiff(names(report_df), "text")
