...
Er zijn `r nrow(report_df)` teksten geanalyseerd met een LLM (model: `r htmltools::htmlEscape(main_model)`),
waarbij het LLM gevraagd werd om het in te delen in één van de volgende `r length(categories)` categorieën:
