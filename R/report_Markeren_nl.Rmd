...
`r .kwallm_report_text_count_summary(analysis_result)` Het LLM (model: `r htmltools::htmlEscape(main_model)`) kreeg de vraag om teksten te markeren die hoorden bij één van de volgende codes:
...
de kolom 'Code' bevat de code waarvoor de tekst is gemarkeerd, en de kolom 'Gemarkeerde tekst' bevat het letterlijke tekstdeel dat door het taalmodel is teruggegeven.
