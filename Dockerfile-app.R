...
options(
  ...
  llm_provider__default_ollama_url = "http://host.docker.internal:11434/api/chat",
  ...
  anonymization__default = "none", # Default anonymization method, either "none', "regex", or "gliner"
